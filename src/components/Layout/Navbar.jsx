    ...
    <>
      ...
      <section className="lg:h-20 md:h-[50px] h-[100%] w-[100%]">
        <nav className="flex justify-between items-center h-full lg:border  md:border bg-lightyellow lg:bg-white md:bg-white">
          ...
          <ul className="lg:flex md:flex h-full items-center w-[50%] hidden lg:ml-[35%] md:ml-[40%]">
            <li className="border-r-2 lg:py-[3.4%] lg:px-[10%]  md:py-[2.8%] md:px-[6%] hover:bg-black hover:text-lightyellow transition duration-300 hover:ease-in-out cursor-pointer ">
              New
            </li>
            <li className="border-r-2 lg:py-[3.4%] lg:px-[10%] md:py-[2.8%] md:px-[6%] hover:bg-black hover:text-lightyellow transition duration-300 hover:ease-in-out cursor-pointer ">
              Women
            ...
            <li className="flex w-full items-center justify-center gap-4">
              <FaUserCircle className="lg:text-3xl md:text-lg" />{" "}
          ...
          <div className="">
            ...
            >
              <li className=" hover:bg-black hover:text-lightyellow transition duration-300 hover:ease-in-out cursor-pointer py-3 px-14 font-bold">
                New
              </li>
              <li className=" hover:bg-black hover:text-lightyellow transition duration-300 hover:ease-in-out cursor-pointer py-3 px-14 font-bold">
                Women
